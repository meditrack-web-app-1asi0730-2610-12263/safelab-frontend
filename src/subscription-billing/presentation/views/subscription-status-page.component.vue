...
<template>
  <main class="billing-page" aria-labelledby="subscription-status-title">
    <header class="page-header">
      <p class="eyebrow">Subscription Billing</p>
      <h1 id="subscription-status-title">Subscription Status</h1>
      <p>
        Check current customer subscriptions, status and device usage.
      </p>
    </header>
    ...
    <section class="summary-grid">
      ...
      <BillingSummaryCard
        ...
        :value="billingStore.subscriptions.length"
